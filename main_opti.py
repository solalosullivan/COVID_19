...
def annealing(parameters, T_i, T_f, c):
...
if __name__ == "__main__":
    ...
    if method == "annealing":
        ...
        c = 0.99  # cooling rate
        n_opt, eta_opt, D_opt = annealing(parameters, T_i, T_f, c)
    ...
    if method == "genetic":
        ...
        n_opt, eta_opt, D_opt = genetic(parameters, nb_choices, nb_iter, p_breed, p_mut)
